                         ...
                         <!--  <label  for="exampleInputPassword2">Type of paper</label><br>
                          ...
                          <select class="form-control" id="state">
                           ...
                           <?php
                            ...
                            <label for="last-name" style="float: left;">Pages:&nbsp;<div id="words"></div></label><br>

                            

                            <input type="number" class="form-control" name="orderpages" id="pages" value="1" min="1" onkeyup="calculateTotal(),calculateUpper(),calculateUnder(),calculateMasters(),calculateDoctoral(),calculateWords()" onclick="calculateTotal(),calculateUpper(),calculateUnder(),calculateMasters(),calculateDoctoral(),calculateWords()">
                          ...
                          <div class="col-md-6 ">
                            ...
                            <label for="exampleInputEmail1" id="lebo">Academic Level</label>

                        <select name="level"  id="Select" class="select form-control">
                          ...
                          <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li class="active pure-menu-item current fao1" id="1"><a href="#tab1" class="pure-menu-link" onclick="calculateTotal()" role="tab" data-toggle="tab"> High School</a></li>

                            <li class="pure-menu-item fao2" id="2"><a href="#tab2" class="pure-menu-link" onclick="calculateUnder()" role="tab" data-toggle="tab">College</a></li>

                            <li class="pure-menu-item fao3" id="3"><a href="#tab3" class="pure-menu-link" onclick="calculateUpper()" role="tab" data-toggle="tab"> University</a></li>

                            <li class="pure-menu-item fao4" id="4"><a href="#tab4" class="pure-menu-link" onclick="calculateMasters()" role="tab" data-toggle="tab"> Masters</a></li>

                            <li class="pure-menu-item fao5" id="5"><a href="#tab5" class="pure-menu-link" onclick="calculateDoctoral()" role="tab" data-toggle="tab"> Doctoral</a></li>
