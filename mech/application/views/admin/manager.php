                                                  ...
                                                  <?php
                                                    ...
                                                    <tr>
                                                       ...
                                                       <td><?php if(isset($row->writer_status_name)) {  echo $row->writer_status_name;  }   ?></td>
                                                        ...
                                                        <td><a href="<?php echo base_url('admin/user_details/').$row->user_id.'/4'; ?>"><button class="btn btn-warning btn-sm">Orders</button></a></td>
                                                         <td><a onclick="return confirm('Delete Manager?')" href="<?php echo base_url('admin/del_manager/').$row->user_id; ?>"><button class="btn btn-danger btn-sm">Delete</button></a></td>
