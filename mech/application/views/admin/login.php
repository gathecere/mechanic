    ...
    <div class="section-authentication-signin d-flex align-items-center justify-content-center my-5 my-lg-0">
      <div class="container-fluid">
        ...
        ?>
                  ...
                  <div class="form-body">
                    <form class="row g-3" action="<?php echo base_url('admin/user_login_process') ?>" method="post">
                      <div class="col-12">
                        <label for="inputEmailAddress" class="form-label">Email Address</label>
                        <input type="email" class="form-control" id="inputEmailAddress" name="admin_email" placeholder="Email Address">
                      </div>
                      <div class="col-12">
                         <label for="inputChoosePassword" class="form-label">Role</label>
                      ...
                      <div class="col-12">
                        ...
                        <div class="input-group" id="show_hide_password">
                          <input type="password" class="form-control border-end-0" name="admin_password" id="inputChoosePassword"  placeholder="Enter Password" class="input-group-text bg-transparent"></a>
                        </div>
                      </div>
