                                                      ...
                                                      <?php
                                                          ...
                                                          <tr>
                                                             ...
                                                             <?php } else { ?>
                                                              ...
                                                              <td><a href="#myModal<?php echo $row->order_id;  ?>" data-bs-toggle="modal" data-bs-target="#myModalyu<?php echo $row->order_id;  ?>"><button class="btn btn-info btn-sm">Update Quotation</button></a></td>
                                                              ...
                                                              <?php } ?>
                                                               ...
                                                               <div class="modal" id="myModalyu<?php echo $row->order_id;  ?>">
                                                                <div class="modal-dialog">
                                                                  <div class="modal-content">
                                                                    ...
                                                                    <!-- Modal body -->
                                                                    <div class="modal-body">
                                                                      <form method="post" action="<?php echo base_url('admin/update_quotation') ?>">

                                                                        <input type="hidden" name="mode" value="2">
                                                                         <input type="hidden" name="order_id" value="<?php if(isset($row->order_id)) { echo $row->order_id;  }   ?>">
                                                                         <label>Amount</label>
                                                                         <input type="number" class="form-control" name="amount" placeholder="amount" value="<?php if(isset($row->order_amount)) { echo $row->order_amount;  }   ?>" required>
