<div class="page-wrapper">
      <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
          <div class="breadcrumb-title pe-3">Stops</div>
          <div class="ps-3">
        ...
        <div class="row">
          <div class="col-xl-9 mx-auto">
            ...
            <span style="float: right; position:relative; right:90px; bottom:30px;"><a class="btn btn-success" data-bs-toggle="modal" data-bs-target="#stopModal"><i class="fa fa-plus"></i>Add Stop</a></span>
            <hr/>
              <div class="card">
                 <div class="card-body">
                                                      ...
                                                      <?php
                                                          ...
                                                          <tr>
                                                              ...
                                                              <td><?php if(isset($row->stop_name)) { echo $row->stop_name;  }   ?></td>
                                                               ...
                                                               <td><a href="<?php echo base_url('admin/edit_stop/').$row->stop_id; ?>"><button class="btn btn-primary btn-sm">Edit Stop</button></a></td>
