...
<html lang="en">
<head>
<title>Essays Corp- Writer</title>
<meta charset="UTF-8" />
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="#" class="logo">
                ...
                <span class="logo-mini"><b>WR</b></span>
                <!-- logo for regular state and mobile devices -->
                <span class="logo-lg"><b></b>Writer ID:#<?php if(isset($user_id)){ echo $user_id;  } ?></span>
            </a>
                       ...
                       <!-- Notifications Menu -->
                        ...
                        <!-- /.messages-menu -->
                         <li class="messages-menu">
                            <a href="<?php echo base_url('writer/inbox'); ?>">
                              ...
                              <span class="label label-success"><?php if(isset($message_count)) { echo $message_count; } ?></span>
                                 ...
                                 <?php  
                                    ...
                                    if($user_writer_status==0){
                                        ?>
                                           <li> <a href=" <?php echo base_url('writer/apply_view'); ?>">Apply</a></li>
                                        <?php
                                    }
                                 ...
                                 <?php  
                                    ...
                                    if($user_writer_status==4){
                                        ?>
                                           <li> <a href=" <?php echo base_url('writer/more_info_view'); ?>">More information needed</a></li>
                                        <?php
                                    }
                        ...
                        <!-- User Account Menu -->
                         ...
                         <?php
                                        ...
                                        <li><a href="<?php echo base_url('writer/change_password') ?>"><i class="icon icon-rotate-right"></i> Change Password</a></li>
                                        <?php } ?>
                        <li class=""><a  href="<?php
