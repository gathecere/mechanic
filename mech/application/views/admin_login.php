              ...
              <div class="row">
                ...
                <div class="col-md-5 col-md-offset-3">
                 ...
                 <div class="login-wrapper">
                       <h3 class="page-title" style="text-align: center; position: relative; bottom: 15px;">Admin Login</h3>
                       <?php
                  ...
                  <form class="form-horizontal" role="form" method="post" action="<?php echo base_url('admin/user_login_process'); ?>">
