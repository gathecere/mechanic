 ...
 <div class="alert text-center cookiealert" role="alert" style="background: black;">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 my-4">
                        <img src="<?= base_url('static/img/looplight.png'); ?>" title="" alt="essayloop logo">
                        <br><br>
                        <p>Specialists in custom papers</p>
                        <p><i class="fa fa-envelope"></i>  support@essayloop.com</p>
                        <p><i class="fa fa-whatsapp"></i>  +1 (309) 992-1394 </p>
                    </div>
                    <div class="col-lg-4 my-4">
                        <h5 class="text-white mb-3">Useful Links</h5>
                        <ul class="list-unstyled white-link footer-links">
                            <li>
                                <a href="<?php echo base_url('order_noe'); ?>">Order Now</a>
                            </li>
                            <li>
                            ...
                            <li>
                             ...
                             <li>
                                <a href="<?php echo base_url('how_it_works'); ?>">Reviews</a>
                            </li>
                              <li>
                    ...
                    <div class="col-lg-4 my-4">
                        ...
                        <ul class="list-unstyled white-link footer-links">
                           ...
                           <img src="<?= base_url('static/img/paypal-white.png'); ?>" class="img-fluid">

                           <img src="<?= base_url('static/img/ssl-encryption.png'); ?>" class="img-fluid" style="width:50%;">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 my-3 text-center text-md-end">
                        <p class="m-0 text-white-50">© 2023 copyright all right reserved</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- End Footer -->
    <!-- Back To Top -->
    <button id="back_to_top" class="back-to-top">
    ...
    <!-- appear -->
    <script async defer src="<?php echo base_url('static/vendor/appear/jquery.appear.js'); ?>"></script>
    <!--bootstrap-->
    <script async defer src="<?php echo base_url('static/vendor/bootstrap/js/bootstrap.bundle.min.js'); ?>"></script>
    <!-- countTo -->
    <script async defer src="<?php echo base_url('static/vendor/counter/jquery.countTo.js'); ?>"></script>
    <!-- typed -->
    <script async defer src="<?php echo base_url('static/vendor/typed/typed.js'); ?>"></script>
    <!-- owl-carousel -->
    <!-- magnific -->
    <script async defer src="<?php echo base_url('static/vendor/magnific/jquery.magnific-popup.min.js'); ?>"></script>
    <!-- isotope -->
    <script async defer src="<?php echo base_url('static/vendor/isotope/isotope.pkgd.min.js'); ?>"></script>
    <!-- svg-injector -->
    <script async defer src="<?php echo base_url('static/vendor/svginjector/svg-injector.min.js'); ?>"></script>
    <!-- jarallax -->
    <script async defer src="<?php echo base_url('static/vendor/jarallax/jarallax-all.js'); ?>"></script>
    <!-- working form -->
    <script async defer src="<?php echo base_url('static/vendor/mail/js/form.min.js'); ?>"></script>
    <script async defer src="<?php echo base_url('static/vendor/mail/js/script.js'); ?>"></script>
    <!-- Theme Js -->
    <script async defer src="<?php echo base_url('static/js/custom.js'); ?>"></script>
