...
// chart 2
 ...
 var ctx = document.getElementById("chart2").getContext('2d');
  ...
  var gradientStroke1 = ctx.createLinearGradient(0, 0, 0, 300);
      gradientStroke1.addColorStop(0, '#00C957');
      gradientStroke1.addColorStop(1, '#00C957');
  ...
  var gradientStroke3 = ctx.createLinearGradient(0, 0, 0, 300);
      ...
      gradientStroke3.addColorStop(1, '#008cff');
  ...
  var gradientStroke5 = ctx.createLinearGradient(0, 0, 0, 300);
      gradientStroke5.addColorStop(0, '#454545');
      gradientStroke5.addColorStop(1, '#454545');

  var gradientStroke6 = ctx.createLinearGradient(0, 0, 0, 300);
      gradientStroke6.addColorStop(0, '#8B1A1A');
      gradientStroke6.addColorStop(1, '#8B1A1A');

      var myChart = new Chart(ctx, {
        type: 'doughnut',
        data: {
          labels: ["EssayLoop", "Your Writer", "Econ Statistics", "Home Work", "Your Essay Shark","MyEssayDoer"],
          datasets: [{
            backgroundColor: [
              gradientStroke1,
              gradientStroke2,
            ...
            data: [loop_numbers, your_numbers, econ_numbers, homework_numbers, essay_numbers, doer_numbers],
